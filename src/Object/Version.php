...
final class Version extends AbstractObject
{
     ...
     * @param VersionEphemeralProperty[] $ephemeral_properties  Properties of the ephemeral version. Returns the version's expiration date, whether it expires after being accessed once, and the action to perform (disable or delete) once the version expires.
    ...
    public function __construct(
        ...
        public bool $latest,
        public array $ephemeral_properties,
